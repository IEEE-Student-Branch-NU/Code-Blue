...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false }) {
    ...
    // REPLACED EXTERNAL ASSETS WITH PRIMITIVES TO PREVENT CRASHES
        ...
        <>
            <group position={[0, 4, 0]}>
                ...
                >
                    ...
                    >
                        {/* REPLACED GLTF MODEL WITH BOX GEOMETRY */}
                        <mesh>
                            <boxGeometry args={[0.8, 1.15, 0.02]} />
                        ...
                        <mesh position={[0, 0.4, 0.02]}>
                            ...
                            <meshStandardMaterial color="#5eb8ff" emissive="#5eb8ff" emissiveIntensity={2} />
                        </mesh>
                    </group>
                </RigidBody>
            </group>
